          ...
          >
            <div className="mb-4 flex flex-shrink-0 items-start justify-between gap-4">
              <div className="flex flex-col gap-1">
                <h2 className="text-lg font-semibold">Tổng quan file Lark — toàn công ty</h2>
                <p className="text-sm text-ink-2">
                  {rows.length} file (chưa xoá) · thuộc dung lượng lưu trữ của tổ chức 2SGROUP.
                </p>
              </div>
              <button
                type="button"
                      ...
                      <div className="flex items-center justify-between gap-4">
                        <div className="flex min-w-0 flex-col gap-0.5">
                          ...
                          <span className="text-xs text-ink-2">
                            ...
                            {departmentLabel(row.creatorDepartment) ?? "chưa gán phòng ban"} ·{" "}
