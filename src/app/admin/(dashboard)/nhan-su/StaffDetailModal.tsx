...
export function StaffDetailModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-ink/50 p-4" onClick={onClose}>
      <div
        className="w-full max-w-[440px] animate-soft-in rounded-card bg-card p-6 shadow-[0_30px_60px_rgba(22,33,62,0.35)]"
      ...
      >
        ...
        <div className="mt-5 flex items-center justify-between gap-4 rounded-2xl border border-red-200 bg-red-50/50 px-4 py-3">
          <div className="flex flex-col gap-0.5">
            ...
            <span className="text-xs text-red-700/70">Hiện tại: {ROLE_LABELS[person.role]} · {departmentLabel(person.department) ?? "chưa gán phòng ban"}</span>
          </div>
