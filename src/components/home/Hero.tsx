...
const HERO_SLIDES = [
  { src: "/images/banner-kitchen-bathroom.png", promo: false },
  { src: "/images/banner-product-closeup.png", promo: false },
  { src: "/images/banner-warehouse.png", promo: false },
  // These two already carry their own full ad copy/branding, so the
  // headline overlay below is hidden for them to avoid double text.
  { src: "/images/banner-saiza-clean-promo.png", promo: true },
  { src: "/images/banner-silky-clean-promo.png", promo: true },
];
...
export function Hero() {
  ...
  const isPromoSlide = HERO_SLIDES[activeIdx].promo;
