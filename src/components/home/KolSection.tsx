        ...
        >
          {loopedKol.map((kol, i) => (
            <figure
              ...
              className="relative m-0 aspect-[3/4] w-50 flex-shrink-0 overflow-hidden rounded-[24px] bg-wash shadow-[0_10px_26px_rgba(22,33,62,0.08)] transition-transform duration-400 ease-soft hover:z-[2] hover:-translate-y-2 hover:scale-105 hover:[transform:translateY(-8px)_rotateX(4deg)_rotateY(-6deg)_scale(1.05)] hover:shadow-[0_22px_34px_rgba(18,41,42,0.28)]"
            >
