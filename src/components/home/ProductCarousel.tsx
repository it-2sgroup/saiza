          ...
          {loopedProducts.map((product, i) => (
            ...
            >
              ...
              <div className="flex flex-1 flex-col gap-2.5 p-5.5">
                ...
                <h3 className="text-[17px] leading-[1.35] font-semibold">{product.name[locale]}</h3>
                <p className="flex-1 text-sm leading-[1.65] text-ink-2">{product.descShort[locale]}</p>
                <Link href={`/san-pham/${product.slug}`} className="mt-1.5 text-sm font-semibold">
