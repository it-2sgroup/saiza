    ...
    <article className="flex flex-col overflow-hidden rounded-card border border-line bg-card">
      ...
      <div className="flex flex-1 flex-col gap-3 p-6">
        ...
        <div className="mt-1.5 flex flex-wrap gap-2.5">
          <button
            type="button"
            className="cursor-pointer rounded-full bg-accent px-4.5 py-2.5 text-[13.5px] font-semibold text-white hover:bg-ink"
          >
            {t.productsPage.buyShopee}
          </button>
          <button
            type="button"
            className="cursor-pointer rounded-full border border-line px-4.5 py-2.5 text-[13.5px] font-semibold hover:border-ink"
          >
