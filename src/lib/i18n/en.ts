...
export const en: Dictionary = {
  ...
  home: {
    ...
    stats: {
      productLines: "SAIZA product lines",
      antibacterial: "Antibacterial efficacy",
      marketplaces: "Official on Shopee, TikTok Shop, Lazada",
      safeIngredients: "Gentle, skin-safe ingredients",
    },
    trust: [
