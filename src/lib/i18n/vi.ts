...
export const vi: Dictionary = {
  ...
  home: {
    ...
    stats: {
      productLines: "Dòng sản phẩm SAIZA",
      antibacterial: "Hiệu quả kháng khuẩn",
      marketplaces: "Sàn TMĐT chính hãng: Shopee, TikTok, Lazada",
      safeIngredients: "Thành phần lành tính, an toàn cho da",
    },
    trust: [
